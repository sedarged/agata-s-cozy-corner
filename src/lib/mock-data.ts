...
export const books: Book[] = [
  {
    ...
    isbn: "9781529029581",
    cover_url: cover("9781529029581"),
    coverGradient: "linear-gradient(135deg,#c7d8e0,#7a96a8)",
    coverAccent: "#3a2418",
    description:
      "W cichej tokijskiej kawiarni można cofnąć się w czasie — jeśli zdążysz, nim wystygnie kawa.",
    pageCount: 224,
    currentPage: 142,
    publishedDate: "2015",
    genre: "Powieść współczesna",
    status: "reading",
    rating: 9,
    isFavourite: false,
    tags: ["japonia", "czas", "ciepłe"],
  },
  {
    id: "2",
    title: "Małe cuda z zakładu pogrzebowego",
    author: "Nuria Roca",
    isbn: "9788367616317",
    cover_url: cover("9788367616317"),
    coverGradient: "linear-gradient(135deg,#e6efe2,#a8c0a4)",
    coverAccent: "#3a4a2a",
    description: "Ciepła hiszpańska powieść o stracie, codziennych cudach i odnajdywaniu siebie.",
    pageCount: 312,
    currentPage: 0,
    publishedDate: "2023",
  ...
  },
  {
    ...
    isbn: "9780312577223",
    cover_url: cover("9780312577223"),
    coverGradient: "linear-gradient(135deg,#f3ecd8,#d1b878)",
    coverAccent: "#3a2a18",
    description:
      "Dwie siostry we Francji podczas II wojny światowej — historia odwagi i siostrzanej miłości.",
    pageCount: 528,
    currentPage: 528,
    publishedDate: "2015",
    ...
    rating: 10,
    isFavourite: true,
    tags: ["wojna", "siostry", "francja"],
  },
  {
    id: "4",
    title: "Północna biblioteka",
    author: "Matt Haig",
    isbn: "9781786892713",
    cover_url: cover("9781786892713"),
    coverGradient: "linear-gradient(135deg,#1a2a4a,#0a1530)",
    coverAccent: "#e8c547",
    description:
      "Między życiem a śmiercią istnieje biblioteka, gdzie każda książka to inna wersja Twojego życia.",
    pageCount: 304,
    currentPage: 304,
    publishedDate: "2020",
    genre: "Powieść współczesna",
  ...
  },
  {
    ...
    author: "Delia Owens",
    isbn: "9780735219090",
    cover_url: cover("9780735219090"),
    coverGradient: "linear-gradient(135deg,#f0c8a8,#8a4838)",
    coverAccent: "#2a1808",
    description: "Dziewczyna z bagien — historia samotności, miłości i ukrytych prawd.",
    pageCount: 384,
    currentPage: 384,
    publishedDate: "2018",
    genre: "Powieść współczesna",
  ...
  },
  {
    ...
    isbn: "9781447218401",
    cover_url: cover("9781447218401"),
    coverGradient: "linear-gradient(135deg,#c6a0d8,#5a3a78)",
    coverAccent: "#fff3d6",
    description: "Sześć sióstr po śmierci ojca odkrywa tajemnice swojego pochodzenia.",
    pageCount: 496,
    currentPage: 0,
    publishedDate: "2014",
    genre: "Saga rodzinna",
  ...
  },
  {
    ...
    author: "Kristin Hannah",
    isbn: "9781250178602",
    cover_url: cover("9781250178602"),
    coverGradient: "linear-gradient(135deg,#2a3a2a,#0e1a0e)",
    coverAccent: "#e8d9b8",
    description: "Wielki Kryzys w Ameryce — kobieta walczy o przetrwanie swojej rodziny.",
    pageCount: 464,
    currentPage: 0,
    publishedDate: "2021",
    genre: "Powieść historyczna",
    ...
    rating: 8,
    isFavourite: false,
    tags: ["ameryka", "historia"],
  },
  {
    id: "8",
    title: "Atlas szepczących chmur",
    author: "David Mitchell",
    isbn: "9780340822777",
    cover_url: cover("9780340822777"),
    coverGradient: "linear-gradient(135deg,#c8d8e8,#6a8aa8)",
    coverAccent: "#1a2a3a",
    description: "Sześć splecionych historii rozciągniętych w czasie i przestrzeni.",
    pageCount: 528,
    currentPage: 0,
    publishedDate: "2004",
    genre: "Powieść współczesna",
    status: "queue",
    isFavourite: false,
    tags: ["literatura", "czas"],
  },
  {
    id: "9",
    title: "Dom przy ulicy Amélie",
    author: "Kristin Harmel",
    isbn: "9781982158934",
    cover_url: cover("9781982158934"),
    coverGradient: "linear-gradient(135deg,#a8c0a4,#3a5a3a)",
    coverAccent: "#fff3d6",
    description: "Paryska historia o przyjaźni, stracie i książkach, które łączą pokolenia.",
    pageCount: 368,
    currentPage: 0,
    publishedDate: "2021",
    genre: "Powieść obyczajowa",
  ...
  },
  {
    ...
    isbn: "9780553807219",
    cover_url: cover("9780553807219"),
    coverGradient: "linear-gradient(135deg,#3a2a4a,#1a0e2a)",
    coverAccent: "#e8c8d8",
    description: "Magiczny realizm w małym miasteczku, gdzie ogród ma swoje sekrety.",
    pageCount: 304,
    currentPage: 0,
    publishedDate: "2010",
...
export const notes: Note[] = [
  {
    ...
    bookId: "1",
    type: "quote",
    quoteText: "Nie wznosisz się na poziom swoich celów. Spadasz do poziomu swoich systemów.",
    content: "",
    pageNumber: 186,
    isFavourite: true,
    tags: ["motywacja"],
  ...
  },
  {
    ...
    type: "chapter",
    chapterNumber: 12,
    chapterTitle: "Duży zwrot akcji",
    content: "Violet podejmuje trudną decyzję. Stawki zmieniają się całkowicie.",
    pageNumber: 312,
    isFavourite: true,
    tags: ["motywacja", "ważne"],
  ...
  },
  {
    ...
    bookId: "2",
    type: "note",
    content: "Myśli o przeszłości Xadena — w pierwszym tomie były tropy, które przegapiłam.",
    pageNumber: 245,
    isFavourite: false,
    tags: ["teoria"],
  ...
  },
  {
    ...
    bookId: "5",
    type: "quote",
    quoteText: "Nie umrę dziś.",
    content: "",
    pageNumber: 312,
    isFavourite: true,
    tags: ["siła", "violet", "xaden"],
  ...
  },
  {
    ...
    bookId: "3",
    type: "quote",
    quoteText: "Czasem najtrudniejsze wybory prowadzą do najlepszych wersji nas samych.",
    content: "",
    pageNumber: 145,
    isFavourite: true,
    tags: ["wybory", "rozwój"],
  ...
  },
  {
    ...
    type: "chapter",
    chapterNumber: 1,
    chapterTitle: "Wprowadzenie do Akademii Basgiath",
    content: "Budowanie świata. Wrażliwość Violet jest pokazana od początku.",
    pageNumber: 12,
    isFavourite: false,
    tags: [],
  ...
  },
  {
    ...
    type: "chapter",
    chapterNumber: 2,
    chapterTitle: "Pierwszy trening",
    content: "Violet się męczy. Fizyczne wycieńczenie czuć dosłownie.",
    pageNumber: 38,
    isFavourite: false,
    tags: [],
    createdAt: "2024-05-05",
  },
  {
    ...
    type: "chapter",
    chapterNumber: 3,
    chapterTitle: "Spotkanie z Xadenem",
    content: "Natychmiastowe napięcie. On coś wie o jej rodzinie.",
    pageNumber: 62,
    isFavourite: true,
    tags: ["xaden"],
  ...
  },
  {
    ...
    type: "chapter",
    chapterNumber: 4,
    chapterTitle: "Wyzwania się zaczynają",
    content: "Pierwszy prawdziwy test przetrwania.",
    pageNumber: 88,
    isFavourite: false,
    tags: [],
    createdAt: "2024-05-06",
  },
  {
    ...
    type: "other",
    title: "Lista postaci",
    content: "Violet, Xaden, Mira, Dain, Liam, Rhiannon…",
    isFavourite: false,
    tags: ["referencje"],
  ...
  },
  {
    ...
    type: "other",
    title: "Moje teorie",
    content: "Ojciec Xadena jest powiązany z venin. Bariery słabną.",
    isFavourite: true,
    tags: ["teoria"],
  ...
  },
  {
    ...
    content: "Sprawdzić zasady wiązania ze smokiem w rozdziale 9.",
    isFavourite: false,
    tags: ["todo"],
    createdAt: "2024-05-10",
  },
  {
    ...
    type: "other",
    title: "Luźne myśli",
    content: "Świat wydaje się prawdziwy. Chcę mapy.",
    isFavourite: false,
    tags: [],
  ...
  },
  {
    ...
    bookId: "1",
    type: "other",
    title: "Ulubione momenty",
    content: "Pierwsza scena lotu. Czyste kino.",
    isFavourite: true,
    tags: ["ulubione"],
...
export const initialGigiMessages: GigiMessage[] = [
  ...
  { id: "g2", role: "user", content: "Streścisz mi moje notatki o Fourth Wing?" },
  {
    ...
    role: "gigi",
    content:
      "Jasne! Masz 48 notatek do Fourth Wing. Główne wątki: rozwój, wybory, lojalność, strach i relacje. Wyróżniłaś 12 cytatów — większość o sile i podejmowaniu decyzji. Mam ułożyć z tego refleksję?",
  },
];
