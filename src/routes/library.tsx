...
const filters = ["Wszystkie", "W kolejce", "Zaczęte", "Wstrzymane", "Odrzucone", "Przeczytane", "Ulubione"];
      ...
      {filtered.length === 0 ? (
        <div className="px-5 lg:px-10 mt-8 max-w-md">
          <div className="glass rounded-2xl p-8 text-center">
            ...
            <Link to="/add-book" className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--accent-gold)] text-[var(--bg)] text-sm">
